...
try:
    while True:
        ...
        requests.post(f'https://api.thingspeak.com/update?api_key={write_api_key}&field1={temperature}&field2={humidity}&field3={values[2]}&field4={values[3]}')
